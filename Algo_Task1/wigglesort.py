...
#     RETURN arr
# ///////
# //Time comp: The algorithm has a single loop that runs from i = 1 to n - 1
# which means it executes (n − 1) iterations
# inside each iteration a Constant number of Operations
# One If condition (the main)
# Possibly a swap which also constant 
